...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands_v2::v2_get_window_settings,
            ...
            commands_v2::v2_cast_get_status,
            ...
            commands_v2::v2_airplay_get_status,
