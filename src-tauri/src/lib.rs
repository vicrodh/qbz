...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // CUT-OFF LEGACY COMMANDS (Phase 2 - Auth/session surface)
            // Date: 2026-02-16
            // Primary runtime path: runtime_bootstrap + v2_* auth/session commands.
            // Rollback: uncomment specific command(s) only if a production incident requires it.
            ...
            commands::get_label,
            // CUT-OFF LEGACY COMMANDS (Phase 2 - Playback surface)
            // Primary runtime path: v2_play_track/v2_pause_playback/v2_resume_playback/v2_stop_playback/v2_seek.
            // commands::play_track,
            ...
            // CUT-OFF LEGACY COMMANDS (Phase 2 - Queue surface)
            // Primary runtime path: v2_* queue commands.
            ...
            // CUT-OFF LEGACY COMMANDS (Phase 2 - Radio/context surface)
            // Primary runtime path: v2_create_track_radio + v2_* playback context commands.
