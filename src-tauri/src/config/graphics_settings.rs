//! Tauri graphics settings commands and startup status.
//!
//! Portable graphics settings persistence lives in `qbz-app`. This module keeps
//! Tauri command wrappers and process-local startup status only.

use serde::{Deserialize, Serialize};
use std::sync::atomic::{AtomicBool, Ordering};
use std::sync::{Arc, Mutex};

pub use qbz_app::settings::graphics::{GraphicsSettings, GraphicsSettingsStore};
