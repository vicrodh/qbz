...
impl CoreBridge {
    ...
    /// Get Release Watch — releases from artists, labels, and awards the user
    /// follows. Surfaces the Qobuz "Radar de Novedades" / "Release Watch"
    /// feed used in the official mobile client's Discover screens.
