...
//! - Media key support on macOS
//! - No-op stub on FreeBSD (no D-Bus/MPRIS)
...
// ──────────────────────────────────────────────────────────────────────────────
// Platforms with souvlaki support (Linux + macOS)
// ──────────────────────────────────────────────────────────────────────────────
...
// ──────────────────────────────────────────────────────────────────────────────
// No-op stub for platforms without souvlaki (FreeBSD, etc.)
// ──────────────────────────────────────────────────────────────────────────────
...
mod stub_impl {
    ...
    impl MediaControlsManager {
        ...
        pub fn init(&self, _app: tauri::AppHandle) {
            if self.initialized.swap(true, Ordering::SeqCst) {
                return;
            }
            log::info!("Media controls: no-op on this platform");
        }
...
#[cfg(any(target_os = "linux", target_os = "macos"))]
pub use souvlaki_impl::MediaControlsManager;

#[cfg(not(any(target_os = "linux", target_os = "macos")))]
pub use stub_impl::MediaControlsManager;
